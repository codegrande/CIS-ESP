...
class Block(object):
	...
	def _prepare_fields(self, fields=False):
		...
		This method will dynamically add corresponding offset and unpacker methods to this block.
		Arguments:
	...
	def unpack_string(self, offset, length=False):
		...
		Arguments:
		- `offset`: The relative offset from the start of the block.
		- `length`: (Optional) The length of the string. If no length is provided, the string runs until a NULL.
		Throws:
		- `OverrunBufferException`
		- `IndexError`
		"""
	...
	def unpack_wstring(self, offset, ilength=False):
		...
		Arguments:
		- `offset`: The relative offset from the start of the block.
		- `length`: (Optional) The length of the string. If no length is provided, the string runs until a double NULL.
		Throws:
		- `UnicodeDecodeError`
		- `IndexError`
		"""
