...
class SHITEMLIST(Block):
	...
	# UNKNOWN1
			...
			if _type == SHITEMTYPE.FILE_ENTRY0 or _type == SHITEMTYPE.FILE_ENTRY1 or _type == SHITEMTYPE.FILE_ENTRY2:
				try:
			...
			elif _type == SHITEMTYPE.NETWORK_VOLUME_NAME0 or _type == SHITEMTYPE.NETWORK_VOLUME_NAME1 or _type == SHITEMTYPE.NETWORK_VOLUME_NAME2 or _type == SHITEMTYPE.NETWORK_VOLUME_NAME3:
